  ...
  switch (action.type) {
    case SEND_MESSAGE:
      ...
      if (currentText) {
        ...
        const newMessageId = state.dialogsData[id].messagesAll.length;
        ...
        stateCopy.dialogsData[id] = { ...state.dialogsData[id] };

        stateCopy.dialogsData[id].messagesAll = [
          ...state.dialogsData[id].messagesAll,
          {
            id: newMessageId,
            message: currentText,
          },
    ...
    case ON_MESSAGE_CHANGE:
      ...
      return { ...state, inputMessage: action.textMessage };
