...
let markupDialogsArray = dialogsDataArray.map( el => (<DialogLink photoSrc={photo} dialogName={el.name} id={el.id} lastMessage={el.messagesAll[el.messagesAll.length - 1].message} /> ) )
...
const DialogsList = () => markupDialogsArray
